...
import initializeStore from "../../state-management/configureStore";
...
export const withRedux = (PageComponent: any, { ssr = true } = {}) => {
  const WithRedux = ({ initialReduxState, ...props }: any) => {
    ...
    const store: Store = getOrInitializeStore(initialReduxState);
  ...
  if (ssr || PageComponent.getInitialProps) {
    WithRedux.getInitialProps = async (context: any) => {
      ...
      const reduxStore: Store = getOrInitializeStore();
